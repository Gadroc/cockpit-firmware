...
public:
  CmspDisplayLine(unsigned int address, LiquidCrystal& lcdDisplay, uint8_t line) : StringListener<19>(address), _lcdDisplay(lcdDisplay) {
    _lineTxt[16] = 0;
    _line = line;
  }
